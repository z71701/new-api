...
const (
	...
	MsgTokenIdempotencyKeyTooLong      = "token.idempotency_key_too_long"
	MsgTokenIdempotencyKeyRequired     = "token.idempotency_key_required_desktop"
	MsgTokenIdempotencyConflict        = "token.idempotency_conflict"
	MsgTokenIdempotencyResourceDeleted = "token.idempotency_resource_deleted"
	MsgTokenUserLimitReached           = "token.user_token_limit_reached"
)
